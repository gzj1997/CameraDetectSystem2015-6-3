...
namespace CameraDetectSystem
{
    ...
    class heipi : ImageTools
    {
        ...
        public heipi(HObject Image, Algorithm al)
        {
            gexxs = 1;
            gex = 0;
            //Initial();
        ...
        private void action()
        {
            ...
            HObject ho_RegionErosion1, ho_RegionFillUp, ho_RegionDifference;
            HObject ho_RegionDifference1, ho_ImageReduced1, ho_Region1 = null;
            ...
            HObject ho_RegionErosion3, ho_RegionFillUp2, ho_RegionDifference3;
            HObject ho_RegionDifference4, ho_ImageReduced3, ho_Region3 = null;
            HObject ho_ConnectedRegions3 = null, ho_RegionFillUp3, ho_RegionDifference5;
            HObject ho_ImageReduced4, ho_Region4, ho_ConnectedRegions4;
            ...
            try
            {
                ...
                HOperatorSet.Difference(ho_RegionFillUp, ho_RegionErosion1, out ho_RegionDifference
                    );
                ho_RegionDifference1.Dispose();
                HOperatorSet.Difference(ho_RegionErosion, ho_RegionDifference, out ho_RegionDifference1
                    );
                //外圈面积
                HOperatorSet.AreaCenter(ho_RegionDifference1, out hv_Area, out hv_Row2, out hv_Column2);

                ho_ImageReduced1.Dispose();
                HOperatorSet.ReduceDomain(ho_ImageReduced, ho_RegionDifference1, out ho_ImageReduced1
                    );

                HOperatorSet.Intensity(ho_RegionDifference1, ho_ImageReduced1, out hv_Mean, out hv_Deviation);
                hv_a1 = 0;
                ...
                HOperatorSet.ErosionCircle(ho_Circle2, out ho_RegionErosion2, 3.5);
                ho_RegionErosion3.Dispose();
                HOperatorSet.ErosionCircle(ho_SelectedRegions1, out ho_RegionErosion3, 6.5);
                ho_RegionFillUp2.Dispose();
                HOperatorSet.FillUp(ho_RegionErosion3, out ho_RegionFillUp2);
                ho_RegionDifference3.Dispose();
                HOperatorSet.Difference(ho_RegionFillUp2, ho_RegionErosion3, out ho_RegionDifference3
                    );
                ho_RegionDifference4.Dispose();
                HOperatorSet.Difference(ho_RegionErosion2, ho_RegionDifference3, out ho_RegionDifference4
                    );
                //中圈面积
                HOperatorSet.AreaCenter(ho_RegionDifference4, out hv_Area2, out hv_Row5, out hv_Column5);

                ho_ImageReduced3.Dispose();
                HOperatorSet.ReduceDomain(ho_ImageReduced, ho_RegionDifference4, out ho_ImageReduced3
                    );

                HOperatorSet.Intensity(ho_RegionDifference4, ho_ImageReduced3, out hv_Mean1,
                    out hv_Deviation1);
