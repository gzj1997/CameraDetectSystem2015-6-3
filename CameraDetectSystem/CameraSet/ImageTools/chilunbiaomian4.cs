...
{
    [Serializable]
    class chilunbiaomian4 : ImageTools
    {
        #region ROI
        [NonSerialized]
        ...
        public chilunbiaomian4()
        {
            //RegionToDisp = Image;
            HOperatorSet.GenEmptyObj(out RegionToDisp);
            RegionToDisp.Dispose();
        }
        public chilunbiaomian4(HObject Image, Algorithm al)
        {
            gexxs = 1;
            gex = 0;
            //Initial();
        ...
        private void action()
        {
            ...
            try
            {
                ...
                ho_Circle2.Dispose();
                HOperatorSet.GenCircle(out ho_Circle2, hv_Row1, hv_Column1, hv_Radius1 * 0.88);
