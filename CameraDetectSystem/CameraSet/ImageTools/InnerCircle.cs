...
{
    [Serializable]
    public class InnerCircletool : ImageTools
    {
        #region ROI
        [NonSerialized]
        ...
        #endregion
        public InnerCircletool()
        {
            HOperatorSet.GenEmptyObj(out RegionToDisp);
            RegionToDisp.Dispose();
        }
        public InnerCircletool(HObject Image, Algorithm al)
        {
            Initial();
            this.Image = Image;
            ...
            out HTuple hv_Circularity)
        {
            ...
            try
            {
                ...
                HOperatorSet.ShapeTrans(ho_RegionFillUp, out ho_outCircle, "inner_circle");
                ...
                HOperatorSet.Roundness(ho_RegionFillUp, out dist, out sigma, out hv_Circularity, out sides);
